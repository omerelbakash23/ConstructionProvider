...
class Branchcarer extends StatefulWidget {
  const Branchcarer({super.key});

  @override
  State<Branchcarer> createState() => _BranchcarerState();
}

class _BranchcarerState extends State<Branchcarer> {
  bool isopen = false;
bool langs =false;
                       ...
                       Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),border: Border.all(color: const Color.fromARGB(16, 158, 158, 158))),
                            ...
                            child: Padding(
                              ...
                              child: Padding(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,textDirection: TextDirection.rtl,
                                  children: [
                                    Text("خشب",style: Theme.of(context)
                                      .textTheme
                                      .displayLarge!
                            ...
                            child: Padding(
                              ...
                              child: Padding(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,textDirection: TextDirection.rtl,
                                  children: [
                                    Text("مسامير",style: Theme.of(context)
                                      .textTheme
                                      .displayLarge!
       ...
       Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),border: Border.all(color: const Color.fromARGB(16, 158, 158, 158))),
                            ...
                            child: Padding(
                              ...
                              child: Padding(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,textDirection: TextDirection.rtl,
                                  children: [
                                    Text("حليه",style: Theme.of(context)
                                      .textTheme
                                      .displayLarge!
                            ...
                            child: Padding(
                              ...
                              child: Padding(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,textDirection: TextDirection.rtl,
                                  children: [
                                    Text("زوايا",style: Theme.of(context)
                                      .textTheme
                                      .displayLarge!
