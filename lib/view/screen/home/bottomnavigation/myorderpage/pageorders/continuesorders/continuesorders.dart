...
import 'package:constructionprovider1/view/screen/home/bottomnavigation/myorderpage/pageorders/continuesorders/opencontinues.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Continueorders extends StatelessWidget {
  const Continueorders({super.key});
    ...
    return SafeArea(
      child: Scaffold(backgroundColor: Colors.white,
          body: ListView.builder(itemCount: 6,itemBuilder: (context, index) =>  Padding(
            ...
            child: InkWell(onTap: () {
              Get.to(()=>const OpenContinueorders());
            },
              child:  Container(
