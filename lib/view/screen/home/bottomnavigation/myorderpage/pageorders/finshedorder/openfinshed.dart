...
import 'package:constructionprovider1/view/screen/home/bottomnavigation/myorderpage/pageorders/dilogs/ratingOrder.dart';
import 'package:constructionprovider1/view/screen/home/bottomnavigation/myorderpage/pageorders/dilogs/ratingnotready.dart';
import 'package:constructionprovider1/view/screen/home/bottomnavigation/myorderpage/pageorders/receipt.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class OpenFinshedOrders extends StatefulWidget {
   const OpenFinshedOrders({super.key});

  @override
  State<OpenFinshedOrders> createState() => _OpenFinshedOrdersState();
}
      bool ispay =true;
      bool haverating =true;

class _OpenFinshedOrdersState extends State<OpenFinshedOrders> {
  @override
                          ...
                          ,
                            Padding(
                             ...
                             Padding(
                               ...
                               child: Center(child: Container(width: 80,height: 80,child: ispay? Image.asset(AppImageAssets.payok,scale: 7,):Image.asset(AppImageAssets.paynot)),),
                             )
                              ...
                              , Row(textDirection: TextDirection.rtl,mainAxisAlignment: MainAxisAlignment.center,
                                 children: [
                                   ElevatedButton(style:ElevatedButton.styleFrom(side: const BorderSide(color: Colors.black,width: 1.2),shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),backgroundColor:const Color.fromARGB(255, 239, 237, 237),),
                                                   onPressed: (){Get.to(()=>const Receiptpage());},
                                                    child: Padding(
                                                     padding:  EdgeInsets.only(right:  MediaQuery.of(context).size.width*.04,left:  MediaQuery.of(context).size.width*.04,top: 10,bottom: 10),
                                                     child: Text("View receipt".tr,style: Theme.of(context)
                                                                    .textTheme
                                                                    .displayLarge!
                                                                    .copyWith(
                                                                        fontSize: 16,
                                   ...
                                   ,const SizedBox(width:15),
                                                   ElevatedButton(style:ElevatedButton.styleFrom(side: const BorderSide(color: Colors.black,width: 1.2),shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),backgroundColor:const Color.fromARGB(255, 239, 237, 237),),
                                                   onPressed: (){haverating?Get.defaultDialog(title:"",content:const ValuationOrder()):Get.defaultDialog(title:"",content: const NoRatingready());},
                                                    child: Padding(
                                                     padding:  EdgeInsets.only(right:  MediaQuery.of(context).size.width*.04,left:  MediaQuery.of(context).size.width*.04,top: 10,bottom: 10),
                                                     child: Text("View rating".tr,style: Theme.of(context)
                                                                    .textTheme
                                                                    .displayLarge!
                                                                    .copyWith(
                                                                        fontSize: 16,
                                      ...
                                      Padding(
                                     padding:  EdgeInsets.only(right: 5,left: 5,top: MediaQuery.of(context).size.height*.04),
