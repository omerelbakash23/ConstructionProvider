...
import 'package:constructionprovider1/view/screen/home/bottomnavigation/myorderpage/pageorders/finshedorder/openfinshed.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class FinshedOrders extends StatelessWidget {
  const FinshedOrders({super.key});
    ...
    return SafeArea(
      child: Scaffold(backgroundColor: Colors.white,
          body: ListView.builder(itemCount: 6,itemBuilder: (context, index) =>  Padding(
            ...
            child: InkWell(onTap: () {
              Get.to(()=>const OpenFinshedOrders());
            },
              child:  Container(
