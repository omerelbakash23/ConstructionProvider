...
class CustomField3 extends StatefulWidget {
   const CustomField3({super.key});

  @override
  State<CustomField3> createState() => _CustomField3State();
}
  int? sub_category_idscontroller;

class _CustomField3State extends State<CustomField3> {
bool isopen = false;
bool langs =false;
IdWithNameModel ? selectedsecondbranch ;
List <IdWithNameModel>secondbranchlist=[
  IdWithNameModel(id:1,name: "محاره"),
  IdWithNameModel(id:2,name: "سباكه"),
   IdWithNameModel(id:3,name: "نجاره "),
  IdWithNameModel(id:4,name: "نقاشه"),
                            ...
                            child: Padding(
                              ...
                              child: InkWell(onTap: () {
                                setState(() {
                                  ...
                                  sub_category_idscontroller=secondbranchlist[index].id;
                                });
                              }, child: Padding(
