...
class VeryFiyCodePage extends StatelessWidget {
  const VeryFiyCodePage({super.key});
            ...
            children: [
             Padding(
               ...
               child: Row(textDirection: TextDirection.rtl,
                 children: [
                   InkWell(child: Image.asset("assets/images/Vector.png"),onTap:(){Get.off(()=>const ForgetPassword());}),
                 ],
               ),
             ),
